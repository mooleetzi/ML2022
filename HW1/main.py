...
def select_feat(train_data, valid_data, test_data, select_all=True):
    ...
    if select_all:
        ...
        # 分析相关性 > 0.8, 共21个特征
        feat_idx = [40, 52, 53, 54, 55, 56, 68, 69, 70, 71, 72, 84, 85, 86, 87, 88, 100, 101, 102, 103,
                    104]  # TODO: Select suitable feature columns.
...
def trainer(train_loader, valid_loader, model, config, device):
    ...
    optimizer = torch.optim.Adam(model.parameters(), lr=config['learning_rate'], betas=(0.99, 0.999), eps=1e-8,
                                 weight_decay=1e-5)
